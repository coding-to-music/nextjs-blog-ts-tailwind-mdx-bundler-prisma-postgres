...
export default function AboutPage() {
  ...
  return (
    <Layout>
      <Seo
        templateTitle='About'
        description='BloggerName is a front-end developer that started learning in May 2020. He write blogs about his approach and mental model on understanding topics in front-end development.'
      />
          ...
          <div className='layout min-h-main py-20'>
            ...
            <div className='mt-4' data-fade='2'>
              ...
              <article className='prose dark:prose-invert'>
                <p data-fade='3'>
                  Hello! I'm BloggerName. I started learning web development in
                  May 2020, which is the start of the pandemic. I have nothing
                  much to do so I decided to learn web development from a udemy
